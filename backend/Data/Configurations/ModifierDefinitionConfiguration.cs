    ...
    public void Configure(EntityTypeBuilder<ModifierDefinition> builder)
    {
        ...
        builder.HasData(
            ...
            new ModifierDefinition
            {
                ...
                Name = "Жажда",
                Description =
                    "«Жажда» увеличивает стоимость одного убийства на 5 очков за каждое убийство в раунде. "
                    + "Каждая активация добавляет такой бонус отдельно. Пример: карточка 100, одна активация "
                    + "и три убийства — бонус 15 к стоимости, поэтому итог равен 115 × 3 = 345. Если убийств "
                    + "нет, каждая активация даёт штраф 25 очков; штраф пустой карточки применяется отдельно.",
