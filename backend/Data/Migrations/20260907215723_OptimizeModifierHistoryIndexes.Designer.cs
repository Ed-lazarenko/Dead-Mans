...
namespace backend.Data.Data.Migrations
{
    ...
    [Migration("20260907215723_OptimizeModifierHistoryIndexes")]
    partial class OptimizeModifierHistoryIndexes
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("game_finalizations", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_game_finalizations_counts_non_negative", "completed_round_count >= 0 AND cancelled_round_count >= 0 AND skipped_quiz_question_count >= 0");
                        });
                });
            ...
            modelBuilder.Entity("backend.Data.Entities.GameQuizManualAward", b =>
                {
                    ...
                    b.Property<int?>("AvailablePointsAfter")
                        .HasColumnType("integer")
                        .HasColumnName("available_points_after");

                    b.Property<int?>("AvailablePointsBefore")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("RequestId")
                        .IsUnique()
                        .HasDatabaseName("ix_game_quiz_manual_awards_request_id")
                    ...
                    b.ToTable("game_quiz_manual_awards", null, t =>
                        {
                            t.HasCheckConstraint("ck_game_quiz_manual_awards_adjustment_audit", "request_id IS NULL OR (reason IS NOT NULL AND length(trim(reason)) BETWEEN 3 AND 500 AND available_points_before IS NOT NULL AND available_points_after IS NOT NULL AND available_points_after >= 0)");

                            t.HasCheckConstraint("ck_game_quiz_manual_awards_operation_sign", "(operation_type = 'award' AND points > 0) OR (operation_type = 'deduct' AND points < 0)");

                            t.HasCheckConstraint("ck_game_quiz_manual_awards_operation_type", "operation_type IN ('award', 'deduct')");

                            t.HasCheckConstraint("ck_game_quiz_manual_awards_points_nonzero", "points <> 0");
                        });
                });
            ...
            modelBuilder.Entity("backend.Data.Entities.GameTeamFinalResult", b =>
                {
                    ...
                    b.Property<string[]>("ParticipantNamesSnapshot")
                        .IsRequired()
                        .HasColumnType("text[]")
                    ...
                    b.HasIndex("TeamId")
                        .HasDatabaseName("ix_game_team_final_results_team_id");
                    ...
                    b.ToTable("game_team_final_results", null, t =>
                        {
                            t.HasCheckConstraint("ck_game_team_final_results_rounds_non_negative", "rounds_played >= 0");
            ...
            modelBuilder.Entity("backend.Data.Entities.ModifierDefinitionVersion", b =>
                {
                    ...
                    b.ToTable("modifier_definition_versions", null, t =>
                        {
                            t.HasCheckConstraint("ck_modifier_definition_versions_behavior_v2_schema", "behavior_v2_json ->> 'schemaVersion' = '2'");

                            t.HasCheckConstraint("ck_modifier_definition_versions_category_allowed", "category IN ('preparation','round','result')");

                            t.HasCheckConstraint("ck_modifier_definition_versions_change_note", "change_note IS NULL OR length(change_note) BETWEEN 1 AND 500");
            ...
            modelBuilder.Entity("backend.Data.Entities.ModifierDefinitionVersionConflict", b =>
                {
                    ...
                    b.HasIndex("ConflictingModifierId")
                        .HasDatabaseName("ix_modifier_definition_version_conflicts_conflicting_modifier_~");

                    b.ToTable("modifier_definition_version_conflicts", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Data.Entities.GameEnabledModifier", b =>
                {
                    ...
                    b.HasOne("backend.Data.Entities.ModifierDefinitionVersion", "ModifierVersion")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_game_enabled_modifiers_modifier_definition_versions_modifie~");
            ...
            modelBuilder.Entity("backend.Data.Entities.GameModifierActivation", b =>
                {
                    ...
                    b.HasOne("backend.Data.Entities.ModifierDefinitionVersion", "ModifierVersion")
                        ...
                        .HasPrincipalKey("ModifierId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_game_modifier_activations_modifier_definition_versions_modi~");
            ...
            modelBuilder.Entity("backend.Data.Entities.GameTeamFinalResult", b =>
                {
                    ...
                    b.HasOne("backend.Data.Entities.GameTeam", "Team")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_game_team_final_results_game_teams_team_id");
            ...
            modelBuilder.Entity("backend.Data.Entities.ModifierDefinition", b =>
                {
                    ...
                    b.HasOne("backend.Data.Entities.ModifierDefinitionVersion", "CurrentVersion")
                        ...
                        .HasPrincipalKey("ModifierId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_modifier_definitions_modifier_definition_versions_id_curren~");
            ...
            modelBuilder.Entity("backend.Data.Entities.ModifierDefinitionVersion", b =>
                {
                    b.HasOne("backend.Data.Entities.ModifierDefinition", "CascadeSourceModifier")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_modifier_definition_versions_modifier_definitions_cascade_s~");
                    ...
                    b.HasOne("backend.Data.Entities.ModifierDefinition", "Modifier")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_modifier_definition_versions_modifier_definitions_modifier_~");
            ...
            modelBuilder.Entity("backend.Data.Entities.ModifierDefinitionVersionConflict", b =>
                {
                    b.HasOne("backend.Data.Entities.ModifierDefinition", "ConflictingModifier")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_modifier_definition_version_conflicts_modifier_definitions_~");
                    ...
                    b.HasOne("backend.Data.Entities.ModifierDefinitionVersion", "ModifierVersion")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_modifier_definition_version_conflicts_modifier_definition_v~");
