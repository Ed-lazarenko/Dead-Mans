...
public class ProductionBaseline : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddForeignKey("fk_game_round_modifier_results_modifier_definitions_modifier_id", "game_round_modifier_results", "modifier_id", "modifier_definitions", null, null, "id", ReferentialAction.NoAction, ReferentialAction.Restrict);
