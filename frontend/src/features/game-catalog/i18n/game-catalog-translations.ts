  ...
  en: {
    ...
    modifiers: {
      ...
      wizard: {
        ...
        steps: { 0: 'Card', 1: 'Rule and activation', 2: 'Impact', 3: 'Review' },
        ...
        phase: 'Active stage',
        phases: { preparation: 'Preparation', round: 'Gameplay', result: 'Round result' },
        performer: 'Who performs the rule',
        performers: { activeTeam: 'Active team', mentor: 'Mentor' },
        rule: 'Rule for the team and host',
        requiresHostMonitoring: 'The host must monitor this rule',
        ...
        formulas: {
          growing_kill_value: 'Growing value of every kill',
          bonus_kill_on_condition: 'Bonus kill when a condition succeeds',
          bonus_kills_by_count: 'Bonus kills for each counted unit',
          window_kill_bonus_points: 'Extra points for kills in a window',
        },
        parameters: {
  ...
  ru: {
    ...
    modifiers: {
      ...
      wizard: {
        ...
        steps: { 0: 'Карточка', 1: 'Правило и активация', 2: 'Влияние', 3: 'Проверка' },
        ...
        phase: 'Стадия действия',
        phases: { preparation: 'Подготовка', round: 'Игра', result: 'Итог раунда' },
        performer: 'Кто выполняет правило',
        performers: { activeTeam: 'Активная команда', mentor: 'Ментор' },
        rule: 'Правило для команды и ведущего',
        requiresHostMonitoring: 'Ведущий должен следить за выполнением',
        ...
        formulas: {
          growing_kill_value: 'Растущая стоимость каждого убийства',
          bonus_kill_on_condition: 'Бонусное убийство при выполнении условия',
          bonus_kills_by_count: 'Бонусные убийства за каждую единицу',
          window_kill_bonus_points: 'Дополнительные очки за убийства в окне',
        },
        parameters: {
        ...
        exampleTitle: 'Расчётный пример backend',
        exampleFacts:
  ...
  uk: {
    ...
    modifiers: {
      ...
      wizard: {
        ...
        steps: { 0: 'Картка', 1: 'Правило й активація', 2: 'Вплив', 3: 'Перевірка' },
        ...
        phase: 'Стадія дії',
        phases: { preparation: 'Підготовка', round: 'Гра', result: 'Підсумок раунду' },
        performer: 'Хто виконує правило',
        performers: { activeTeam: 'Активна команда', mentor: 'Ментор' },
        rule: 'Правило для команди та ведучого',
        requiresHostMonitoring: 'Ведучий має стежити за виконанням',
        ...
        formulas: {
          growing_kill_value: 'Зростаюча вартість кожного вбивства',
          bonus_kill_on_condition: 'Бонусне вбивство за виконання умови',
          bonus_kills_by_count: 'Бонусні вбивства за кожну одиницю',
          window_kill_bonus_points: 'Додаткові очки за вбивства у вікні',
        },
        parameters: {
        ...
        exampleTitle: 'Розрахунковий приклад backend',
        exampleFacts:
  ...
  pl: {
    ...
    modifiers: {
      ...
      wizard: {
        ...
        steps: { 0: 'Karta', 1: 'Reguła i aktywacja', 2: 'Wpływ', 3: 'Sprawdzenie' },
        ...
        phase: 'Etap działania',
        phases: { preparation: 'Przygotowanie', round: 'Rozgrywka', result: 'Wynik rundy' },
        performer: 'Kto wykonuje regułę',
        performers: { activeTeam: 'Aktywna drużyna', mentor: 'Mentor' },
        rule: 'Reguła dla drużyny i prowadzącego',
        requiresHostMonitoring: 'Prowadzący musi monitorować tę regułę',
        ...
        formulas: {
          growing_kill_value: 'Rosnąca wartość każdego zabójstwa',
          bonus_kill_on_condition: 'Dodatkowe zabójstwo po spełnieniu warunku',
          bonus_kills_by_count: 'Dodatkowe zabójstwa za każdą jednostkę',
          window_kill_bonus_points: 'Dodatkowe punkty za zabójstwa w oknie',
        },
        parameters: {
        ...
        exampleTitle: 'Przykład obliczony przez backend',
        exampleFacts:
