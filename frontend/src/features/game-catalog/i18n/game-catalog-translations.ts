const translations = {
  en: {
    ...
    modifiers: {
      ...
      menuDescription: 'Add new modifiers to the global catalog.',
      ...
      fields: {
        ...
        activationLimitScope: 'Limit scope',
  ...
  ru: {
    ...
    modifiers: {
      ...
      menuDescription: 'Добавляйте новые модификаторы в глобальный каталог.',
      menuHint: 'Чтобы изменить или удалить запись, используйте кнопки в строке модификатора.',
      meta: '{{kind}} · стоимость {{cost}}',
      ...
      fields: {
        ...
        activationLimitScope: 'Область лимита',
  ...
  uk: {
    ...
    modifiers: {
      ...
      menuDescription: 'Додавайте нові модифікатори до глобального каталогу.',
      menuHint: 'Щоб змінити або видалити запис, використовуйте кнопки в рядку модифікатора.',
      meta: '{{kind}} · вартість {{cost}}',
      ...
      fields: {
        ...
        activationLimitScope: 'Область ліміту',
  ...
  pl: {
    ...
    modifiers: {
      ...
      menuDescription: 'Dodawaj nowe modyfikatory do globalnego katalogu.',
      menuHint: 'Aby edytować lub usunąć wpis, użyj przycisków w wierszu modyfikatora.',
      meta: '{{kind}} · koszt {{cost}}',
      ...
      fields: {
        ...
        activationLimitScope: 'Zakres limitu',
