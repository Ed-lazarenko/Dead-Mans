const translations = {
  en: {
    ...
    cellMediaEmpty: 'No description or media details are available for this card.',
    ...
    cardPlayResultModifiers: 'Modifiers',
    cardPlayResultNoModifiers: 'No modifiers',
    cardPlayResultTotalPenalty: 'Total penalty',
    cardPlayResultPenaltyValue: 'Penalty {{value}} pts',
    cardPlayResultModifierKillDelta: '{{value}} kills',
    cardPlayResultModifierMultiplier: 'x{{value}} multiplier',
    cardPlayResultModifierCalculation: 'Calculation: {{details}}',
    cardPlayResultModifierConditionMet: 'condition met',
    cardPlayResultModifierConditionMissed: 'condition missed',
    cardPlayResultModifierConditionType: 'condition {{type}}',
    cardPlayResultModifierInputValue: '{{input}} {{count}}',
    cardPlayResultModifierCountValue: 'value {{count}}',
    cardPlayResultModifierKillDeltaValue: '{{value}} kills per unit',
    cardPlayResultModifierMultiplierDelta: '{{value}} multiplier delta',
    cardPlayResultModifierInputBonusKills: 'bonus kills',
    cardPlayResultModifierInputMentorKills: 'mentor kills',
    cardPlayResultModifierInputKillsDuringWindow: 'kills in window',
    cardPlayResultModifierKillsCount: '{{count}} kills',
    cardPlayResultModifierBountyCount: '{{count}} bounties',
    cardPlayResultModifierActivationCount: '{{count}} activations',
    cardPlayResultModifierPerKillBonus: '{{value}} per kill',
    cardPlayResultModifierFailurePenalty: '{{value}} failure penalty',
    cardPlayResultModifierFormulaMode: 'formula {{mode}}',
    cardPlayResultModifierFormulaModeFlatPerKill: 'flat per kill',
    cardPlayResultModifierFormulaModeStackingPerKillBonus: 'stacking per kill',
    cardPlayResultModifierFormulaModeCustomExpression: 'custom expression',
    cardPlayResultModifierExpression: '{{label}}: {{expression}}',
    cardPlayResultModifierSuccessExpression: 'success',
    cardPlayResultModifierFailureExpression: 'failure',
    statusActive: 'Active',
  ...
  ru: {
    ...
    cellMediaEmpty: 'Для этой карточки нет описания или дополнительных деталей.',
    ...
    cardPlayResultModifiers: 'Модификаторы',
    cardPlayResultNoModifiers: 'Без модификаторов',
    cardPlayResultTotalPenalty: 'Итоговый штраф',
    cardPlayResultPenaltyValue: 'Штраф {{value}} очк.',
    cardPlayResultModifierKillDelta: '{{value}} убийств',
    cardPlayResultModifierMultiplier: 'множитель x{{value}}',
    cardPlayResultModifierCalculation: 'Расчёт: {{details}}',
    cardPlayResultModifierConditionMet: 'условие выполнено',
    cardPlayResultModifierConditionMissed: 'условие не выполнено',
    cardPlayResultModifierConditionType: 'условие {{type}}',
    cardPlayResultModifierInputValue: '{{input}} {{count}}',
    cardPlayResultModifierCountValue: 'значение {{count}}',
    cardPlayResultModifierKillDeltaValue: '{{value}} убийств за единицу',
    cardPlayResultModifierMultiplierDelta: '{{value}} дельта множителя',
    cardPlayResultModifierInputBonusKills: 'бонус-убийства',
    cardPlayResultModifierInputMentorKills: 'ментор-убийства',
    cardPlayResultModifierInputKillsDuringWindow: 'убийства в окне',
    cardPlayResultModifierKillsCount: 'убийства {{count}}',
    cardPlayResultModifierBountyCount: 'баунти {{count}}',
    cardPlayResultModifierActivationCount: 'активации {{count}}',
    cardPlayResultModifierPerKillBonus: '{{value}} за убийство',
    cardPlayResultModifierFailurePenalty: '{{value}} штраф за провал',
    cardPlayResultModifierFormulaMode: 'формула {{mode}}',
    cardPlayResultModifierFormulaModeFlatPerKill: 'за каждое убийство',
    cardPlayResultModifierFormulaModeStackingPerKillBonus: 'стак за убийства',
    cardPlayResultModifierFormulaModeCustomExpression: 'кастомная',
    cardPlayResultModifierExpression: '{{label}}: {{expression}}',
    cardPlayResultModifierSuccessExpression: 'успех',
    cardPlayResultModifierFailureExpression: 'провал',
    ...
    finishSummaryTeamsTitle: 'Команды',
  ...
  uk: {
    ...
    cellMediaEmpty: 'Для цієї картки немає опису або додаткових деталей.',
    ...
    cardPlayResultModifiers: 'Модифікатори',
    cardPlayResultNoModifiers: 'Без модифікаторів',
    cardPlayResultTotalPenalty: 'Підсумковий штраф',
    cardPlayResultPenaltyValue: 'Штраф {{value}} очк.',
    cardPlayResultModifierKillDelta: '{{value}} вбивств',
    cardPlayResultModifierMultiplier: 'множник x{{value}}',
    cardPlayResultModifierCalculation: 'Розрахунок: {{details}}',
    cardPlayResultModifierConditionMet: 'умову виконано',
    cardPlayResultModifierConditionMissed: 'умову не виконано',
    cardPlayResultModifierConditionType: 'умова {{type}}',
    cardPlayResultModifierInputValue: '{{input}} {{count}}',
    cardPlayResultModifierCountValue: 'значення {{count}}',
    cardPlayResultModifierKillDeltaValue: '{{value}} вбивств за одиницю',
    cardPlayResultModifierMultiplierDelta: '{{value}} дельта множника',
    cardPlayResultModifierInputBonusKills: 'бонус-вбивства',
    cardPlayResultModifierInputMentorKills: 'ментор-вбивства',
    cardPlayResultModifierInputKillsDuringWindow: 'вбивства у вікні',
    cardPlayResultModifierKillsCount: 'вбивства {{count}}',
    cardPlayResultModifierBountyCount: 'баунті {{count}}',
    cardPlayResultModifierActivationCount: 'активації {{count}}',
    cardPlayResultModifierPerKillBonus: '{{value}} за вбивство',
    cardPlayResultModifierFailurePenalty: '{{value}} штраф за провал',
    cardPlayResultModifierFormulaMode: 'формула {{mode}}',
    cardPlayResultModifierFormulaModeFlatPerKill: 'за кожне вбивство',
    cardPlayResultModifierFormulaModeStackingPerKillBonus: 'стек за вбивства',
    cardPlayResultModifierFormulaModeCustomExpression: 'кастомна',
    cardPlayResultModifierExpression: '{{label}}: {{expression}}',
    cardPlayResultModifierSuccessExpression: 'успіх',
    cardPlayResultModifierFailureExpression: 'провал',
    statusActive: 'Активна',
    ...
    finishSummaryTeamsTitle: 'Команди',
  ...
  pl: {
    ...
    cellMediaEmpty: 'Brak opisu lub dodatkowych szczegółów tej karty.',
    ...
    cardPlayResultModifiers: 'Modyfikatory',
    cardPlayResultNoModifiers: 'Bez modyfikatorów',
    cardPlayResultTotalPenalty: 'Łączna kara',
    cardPlayResultPenaltyValue: 'Kara {{value}} pkt',
    cardPlayResultModifierKillDelta: '{{value}} zabójstw',
    cardPlayResultModifierMultiplier: 'mnożnik x{{value}}',
    cardPlayResultModifierCalculation: 'Kalkulacja: {{details}}',
    cardPlayResultModifierConditionMet: 'warunek spełniony',
    cardPlayResultModifierConditionMissed: 'warunek niespełniony',
    cardPlayResultModifierConditionType: 'warunek {{type}}',
    cardPlayResultModifierInputValue: '{{input}} {{count}}',
    cardPlayResultModifierCountValue: 'wartość {{count}}',
    cardPlayResultModifierKillDeltaValue: '{{value}} zabójstw na jednostkę',
    cardPlayResultModifierMultiplierDelta: '{{value}} delta mnożnika',
    cardPlayResultModifierInputBonusKills: 'bonusowe zabójstwa',
    cardPlayResultModifierInputMentorKills: 'mentor zabójstwa',
    cardPlayResultModifierInputKillsDuringWindow: 'zabójstwa w oknie',
    cardPlayResultModifierKillsCount: 'zabójstwa {{count}}',
    cardPlayResultModifierBountyCount: 'bounty {{count}}',
    cardPlayResultModifierActivationCount: 'aktywacje {{count}}',
    cardPlayResultModifierPerKillBonus: '{{value}} za zabójstwo',
    cardPlayResultModifierFailurePenalty: '{{value}} kara za porażkę',
    cardPlayResultModifierFormulaMode: 'formuła {{mode}}',
    cardPlayResultModifierFormulaModeFlatPerKill: 'za każde zabójstwo',
    cardPlayResultModifierFormulaModeStackingPerKillBonus: 'stack za zabójstwa',
    cardPlayResultModifierFormulaModeCustomExpression: 'własna',
    cardPlayResultModifierExpression: '{{label}}: {{expression}}',
    cardPlayResultModifierSuccessExpression: 'sukces',
    cardPlayResultModifierFailureExpression: 'porażka',
    ...
    finishSummaryTeamsTitle: 'Drużyny',
