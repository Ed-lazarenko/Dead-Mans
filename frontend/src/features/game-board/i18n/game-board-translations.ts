const translations = {
  en: {
    ...
    cardPlayResultEmpty: 'This card has not been completed yet.',
  ...
  ru: {
    ...
    cardPlayResultEmpty: 'Эта карточка ещё не завершена.',
  ...
  uk: {
    ...
    cardPlayResultEmpty: 'Цю картку ще не завершено.',
  ...
  pl: {
    ...
    cardPlayResultEmpty: 'Ta karta nie została jeszcze zakończona.',
