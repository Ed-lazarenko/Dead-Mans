const translations = {
  en: {
    ...
    adminPanel: {
      ...
      createTeamActionsTitle: 'Create a room',
      createTeamActionsDescription:
        'New rooms are added to the first free place in the game queue. Move teams up or down to set turn order.',
  ...
  ru: {
    ...
    adminPanel: {
      ...
      createTeamActionsTitle: 'Создать комнату',
      createTeamActionsDescription:
        'Новая комната попадёт на первое свободное место в игровой очереди. Переставляйте команды выше или ниже, чтобы задать порядок ходов.',
  ...
  uk: {
    ...
    adminPanel: {
      ...
      createTeamActionsTitle: 'Створити кімнату',
      createTeamActionsDescription:
        'Нова кімната потрапить на перше вільне місце в ігровій черзі. Переставляйте команди вище або нижче, щоб задати порядок ходів.',
  ...
  pl: {
    ...
    adminPanel: {
      ...
      createTeamActionsTitle: 'Utwórz pokój',
      createTeamActionsDescription:
        'Nowy pokój trafi na pierwsze wolne miejsce w kolejce gry. Przesuwaj drużyny w górę lub w dół, aby ustawić kolejność tur.',
